...
export const CLIENTS = {
  'connectpx-dashboard': {
    ...
    redirect_uris: [], // will accept any localhost for demo
    token_endpoint_auth_method: 'none',
  },
};

// Dynamic registrations go in memory (good enough for demo)
// In production: persist to DB
export const dynamicClients = new Map();

export function findClient(clientId) {
  return CLIENTS[clientId] || dynamicClients.get(clientId) || null;
}
